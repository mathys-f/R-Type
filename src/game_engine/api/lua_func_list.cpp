...
const std::vector<std::unique_ptr<LuaApiEntryBase>> k_api_functions = []() {
    ...
    temp.emplace_back(std::make_unique<LuaApiEntry<std::string, sol::table>>("Create_ui_text", create_ui_text));
    temp.emplace_back(
        std::make_unique<LuaApiEntry<std::string, std::string>>("Create_ui_input_field", create_ui_input_field));
    ...
    temp.emplace_back(std::make_unique<LuaApiEntry<std::string, sol::table>>("Set_ui_text", set_ui_text));
    temp.emplace_back(std::make_unique<LuaApiEntry<std::string, sol::table>>("Set_ui_navigation", set_ui_navigation));
    return temp;
}();
