...
Create_ui_text("game_over_title", { content = "GAME OVER", font_size = 78 })
...
Create_ui_text("game_over_subtitle", { content = "Mission failed. The fleet will remember your run.", font_size = 22 })
